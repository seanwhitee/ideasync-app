...
<template>
  ...
  <div class="flex mb-5 content-evenly">
    <p class="content-center text-sm font-extrali.ght">身份：</p>
    <div class="dropdown dropdown-hover dropdown-bottom">
      <div tabindex="0" class="m-1 btn glass hover:bg-inherit">
      ...
      >
        <li @click="role = 'creator'" class="hover:bg-zinc-800/50 rounded-box">
          <a>學生</a>
        </li>
        <li @click="role = 'mentor'" class="hover:bg-zinc-800/50 rounded-box">
          <a>指導者</a>
        </li>
      </ul>
    </div>
